...
import user from '../../../pages/About_images/user_1144760.png'
  ...
  return (
    <div>
      <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className='flex mt-10 md:ml-[500px]'>
          <label htmlFor="files" className='cursor-pointer bg-green-400 mr-2 hover:bg-green-600 h-10 text-center w-40 mt-6 rounded-2xl' onClick={handleProfile}>
            <p className='mt-2 hover:text-white '>
              {
                addImage? <span>ADD IMAGE</span>: <span><button onClick={()=>setImage(false)}> Remove Image</button></span>
              }
            </p>
          </label>
              <input type="file" accept="image/*" id='files' className='cursor-pointer hidden bg-red-600' onChange={handleImageChange} />
                <div>
                  <img
                    src={image? user  : selectedImage}
                    alt="Selected"
