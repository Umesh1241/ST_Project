...
const Carousel = () => {
  ...
  return (
    <div className='container px-[-20px] rounded-xl '>
              ...
              <div className='hidden md:flex h-full w-full overflow-hidden'>
                {
                        desktopImages.map((imageURl,index)=>{
                            return(
                            <div className='w-full h-full min-w-full min-h-full transition-all' key={imageURl} style={{transform : `translateX(-${(currentImage * 100)%500}%)`}}>
